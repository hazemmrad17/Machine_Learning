...
// SplitText is a premium plugin - we'll use a fallback
// If you have GSAP premium, uncomment and install:
  ...
  useGSAP(
    () => {
      ...
      document.fonts.ready.then(() => {
        ...
        // Animate header (using fallback since SplitText is premium)
